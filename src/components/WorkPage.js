      ...
      <div className="grid">
        <figure className="effect-zoe">
          ...
          <figcaption>
            ...
            <p className="icon-links">
              <a href="https://github.com/chrisvolante/addressbook-client" target="_blank"><span className="icon-heart">Repo</span></a>
              <a href="https://cryptic-fortress-69642.herokuapp.com/" target="_blank"><span className="icon-eye">Live</span></a>
            </p>
        ...
        <figure className="effect-zoe">
          ...
          <figcaption>
            ...
            <p className="icon-links">
              <a href="https://github.com/chrisvolante/budget-app" target="_blank"><span className="icon-heart">Repo</span></a>
              <a href="https://afternoon-anchorage-88698.herokuapp.com/" target="_blank"><span className="icon-eye">Live</span></a>
            </p>
        ...
        <figure className="effect-zoe">
          ...
          <figcaption>
            ...
            <p className="icon-links">
              <a href="https://github.com/chrisvolante/no-vacation-app" target="_blank"><span className="icon-heart">Repo</span></a>
              <a href="https://chrisvolante.github.io/no-vacation-app/" target="_blank"><span className="icon-eye">Live</span></a>
            </p>
        ...
        <figure className="effect-zoe">
          ...
          <figcaption>
            ...
            <p className="icon-links">
              <a href="https://github.com/chrisvolante/budget-app" target="_blank"><span className="icon-heart">Repo</span></a>
              <a href="https://chrisvolante.github.io/quiz-app/" target="_blank"><span className="icon-eye">Live</span></a>
            </p>
